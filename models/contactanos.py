...
class Contactanos:
    ...
    def agregarDatosgym(self,contacto):
        sql= f"INSERT INTO `contacto_gym` (`id_contacto`, `nombre_gym`, `telefono_gym`, `correo_gym`, `direccion_gym`, `barrio_gym`, `ubicacion_gym`) VALUES (NULL, '{contacto[0]}', '{contacto[1]}', '{contacto[2]}', '{contacto[3]}', '{contacto[4]}', '{contacto[5]}');"
        self.cursor.execute(sql)
        self.conexion.commit()
